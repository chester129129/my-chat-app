...
*   **정확성과 오류방지:** 의미 왜곡, 맥락 벗어난 해석, 불필요한 창의적 추가 철저히 금지.
특히 확인/반복 진술문을 질문문이나 다른 의도로 왜곡하는 오류 방지(예: "일하셨군요"를 "¿Trabajaste?"로 번역 금지).
원문 핵심 메시지 정확 전달, 불분명한 경우 가장 중립적이고 맥락 맞는 해석 우선.
